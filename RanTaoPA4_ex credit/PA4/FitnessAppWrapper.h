...
public:
	...
	void loadWeeklyExcercisePlan(); // this will call the private loadWeeklyPlan() function
	void displayWeeklyExcercisePlan(); // this will call the private displayWeeklyPlan() function
	void storeWeeklyExcercisePlan(); // this will call the private storeWeeklyPlan() function
...
private:
	...
	ExcercisePlan mEPList[7]; // will store the weekly list of ExcercisePlan objects - 1 week = 7 days


	fstream mFstrDP;    // stream object for input/output to dietPlans.txt
	fstream mFstrEP;    // stream object for input/output to ExcercisePlan.txt
